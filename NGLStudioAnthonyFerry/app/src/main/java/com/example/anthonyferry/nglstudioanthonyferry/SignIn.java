...
public class SignIn extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            link = "http://10.0.2.2/nglstudio/get_user.php" + data;
            ...
            Log.d("ojnf", "doudoudoudoudoudoudoudoudoudoudoudoudoud");

            bufferedReader = new BufferedReader(new InputStreamReader(connection.getInputStream()));

            Log.d("ojnf","tititititititititititititititititititititititititititititititititit");

            result = bufferedReader.readLine();


            Log.d("result", result);
            Log.d("oiqe^bgo,qefob,qdfgb", "ÖSETGIGBÖIGQE¨K?SGFNLK?FLKNSGÖB?QDFBLK?SGNB");
        ...
        if (jsonStr != null)
        {
            try {
                ...
                if (query_result.equals("TRUE")) {
                    Toast.makeText(context, "Identifiant good", Toast.LENGTH_SHORT).show();
                } else if (query_result.equals("FALSE")) {
                    Toast.makeText(context, "Identifiant pas good", Toast.LENGTH_SHORT).show();
                } else {
